...
func GetCommand(cmd instructions.Command, fileContext util.FileContext, useNewRun bool, cacheCopy bool, cacheRun bool, output *RunOutput, secrets []string) (DockerCommand, error) {
	switch c := cmd.(type) {

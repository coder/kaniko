...
// IOFS returns the default filesystem as an io/fs.FS.
func IOFS() iofs.FS {
	return FS
}

// Set the filesystem to be used by the package. Changing the filesystem
// is not safe after the package has been used.
